<x-layouts::auth :title="__('Log in')">
    <div class="w-full max-w-5xl overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-900 shadow-2xl grid grid-cols-1 lg:grid-cols-12 min-h-[620px]">
            ...
            <div class="relative z-10">
                ...
                <div class="mt-12 space-y-4">
                    ...
                    <h1 class="text-3xl sm:text-4xl font-extrabold tracking-tight text-white leading-tight">
                        Streamline your <span class="bg-gradient-to-r from-amber-400 via-amber-300 to-orange-400 bg-clip-text text-transparent inline-block pr-2 pb-0.5">developer workflow</span>.
                    </h1>
        ...
        <div class="lg:col-span-6 p-8 sm:p-12 flex flex-col justify-center bg-zinc-900/40">
            <div class="w-full max-w-md mx-auto space-y-6">
                ...
                <form method="POST" action="{{ route('login.store') }}" class="space-y-5" autocomplete="off">
                    ...
                    <div class="space-y-1.5 relative">
                        ...
                        @if (Route::has('password.request'))
                            <flux:link class="absolute top-0 text-xs text-amber-400 hover:text-amber-300 end-0 font-medium transition-colors" :href="route('password.request')" wire:navigate>
                                {{ __('Forgot password?') }}
                            </flux:link>
                        @endif
                    </div>
                ...
                <div class="text-center text-xs text-zinc-400 pt-2">
                    ...
                    <flux:link :href="route('register')" wire:navigate class="text-amber-400 hover:text-amber-300 font-medium ml-1">{{ __('Sign up') }}</flux:link>
                </div>
            </div>
        </div>
